...
class LeggedRobot(BaseTask):
    ...
    def _init_buffers(self):
        ...
        # Torque and gain buffers follow physical DOFs. Action-history buffers
        # follow the policy action space and may be smaller for task-specific
        # action subsets such as BRUCE leg-only control.
