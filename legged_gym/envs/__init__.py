...
from legged_gym.envs.bruce.bruce_stand_config import BruceStandCfg, BruceStandCfgPPO
from legged_gym.envs.bruce.bruce_stand_env import BruceStandRobot
...
task_registry.register( "bruce_stand", BruceStandRobot, BruceStandCfg(), BruceStandCfgPPO())
